(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('topojson'), require('geojson-merge'), require('earcut')) :
	typeof define === 'function' && define.amd ? define(['three', 'topojson', 'geojson-merge', 'earcut'], factory) :
	(global = global || self, global.ObjectivityCity = factory(global.THREE, global.topojson, global.geojsonMerge, global.earcut));
}(this, (function (THREE, topojson, geojsonMerge, earcut) { 'use strict';

	THREE = THREE && THREE.hasOwnProperty('default') ? THREE['default'] : THREE;
	geojsonMerge = geojsonMerge && geojsonMerge.hasOwnProperty('default') ? geojsonMerge['default'] : geojsonMerge;
